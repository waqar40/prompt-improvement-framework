...
The guide lives under the **outcomes dir** `<outcomes>` (`PROMPT_OUTCOMES_DIR`, default the sibling
`../prompts-review-outcomes`), never inside the repo. The **source of truth is
