...
One file per user, stored under the **outcomes dir** (`PROMPT_OUTCOMES_DIR`, default
`~/.claude/prompt-journal/prompts-review-outcomes`), never inside the plugin. It is the backlog that `asset-architect`
